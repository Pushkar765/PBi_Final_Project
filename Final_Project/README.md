🎯 Objectives
Build a robust data model with star schema
...
---
🏁 Conclusion
Built a complete, production-ready Power BI model covering proper data modeling, DAX calculations, time intelligence, 
and interactive multi-page reporting — demonstrating a strong and comprehensive understanding of Power BI concepts.
